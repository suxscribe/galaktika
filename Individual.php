...
<!--		<div class="section-icons section-icons_absolute"></div>-->
		<div class="uk-container uk-container-center container-780 uk-margin-large-bottom" data-uk-scrollspy="{cls:'uk-animation-slide-bottom'}">
			...
			<article class="content">
				...
				<div class="uk-h2 uk-margin-large-bottom service-promo-title">Прекрасная идея посетить центр «Галактика Приключений» с
				...
				<div class="service-promo-txt">
					<p class=" uk-margin-large-bottom">Мы сами организуем команду от 4 человек в соответствии с
					...
					<p class="">У нас даже самые непослушные дети превращаются в настоящих Хранителей
						Галактики!</p>
				</div>
			</article>
		</div>
